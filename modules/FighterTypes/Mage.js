...
export default class Mage extends FighterType {
    ...
    constructor() {
        ...
        this.addSkill(new AttackSkill("Ray of Frost", 10, 15, -1, "enemy", "none", 10, 'icon.png'));
        this.addSkill(new AttackSkill("Ig-miss", 35, 40, 5, "enemy", "none", 10, 'icon.png'));
        this.addSkill(new AttackSkill("Lightning", 50, 60, 4, "enemy", "none", 10, 'icon.png'));
        this.addSkill(new AttackSkill("Heal", 50, 50, 4, "self", "heal", 10, 'icon.png'));
    }
}